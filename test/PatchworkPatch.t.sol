...
contract PatchworkPatchTest is Test {
    ...
    function testPatchFragment() public {
        ...
        assertEq(0, _testPatchLiteRefNFT.getTokenIdForOriginal721(address(_testBaseNFT), baseTokenId));
        assertEq(0, _testPatchLiteRefNFT.getTokenIdForOriginal721(address(_testBaseNFT), baseTokenId2));
        assertEq(fragmentTokenId, _testPatchLiteRefNFT.getTokenIdForOriginal721(address(testPatchFragmentNFT), baseTokenId3));
